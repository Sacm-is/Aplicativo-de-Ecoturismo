...
public class GerenciadorLugares extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GerenciadorLugares frame = new GerenciadorLugares();
	 ...
	 * Create the frame.
	 */
	public GerenciadorLugares() {
		setResizable(false);
		setTitle("Gerenciador de Lugares");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "Select * from dados_lugares";
		...
		btnAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "update dados_lugares set nome_lugar=?, endereco=?, descricao=? where id=?";
		...
		btnAbrir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "select * from dados_lugares where id like ?";
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "delete from dados_lugares where id=?";
