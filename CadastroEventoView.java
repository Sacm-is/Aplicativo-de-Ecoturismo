...
public class CadastroEventoView extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private JTextField tfNomeEvento;
	...
	public CadastroEventoView() {
		...
		tfNomeEvento.setBounds(10, 64, 464, 29);
		contentPane.add(tfNomeEvento);
		tfNomeEvento.setColumns(10);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String nomeLugar = tfNomeEvento.getText();
					...
					String sql = "INSERT INTO dados_Eventos (nome_lugar, endereco, descricao) VALUES (?,?,?);";
					
					PreparedStatement stmt = conexao.prepareStatement(sql);
					
					stmt.setString(1, tfNomeEvento.getText());
		...
		JLabel lblNewLabel_3 = new JLabel("Cadastro de Eventos");
		lblNewLabel_3.setFont(new Font("Dialog", Font.BOLD, 13));
		lblNewLabel_3.setBounds(166, 11, 143, 24);
